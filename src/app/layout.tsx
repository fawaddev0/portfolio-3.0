...
export const metadata: Metadata = {
  title: "Fawad Imran | Full Stack Developer & AI Automation Expert",
  description:
    "Explore the portfolio of Fawad Imran, a Professional Full Stack Developer specializing in Next.js, AI Automation, and modern web solutions. Built for performance and user experience.",
  keywords: [
    "Fawad Imran",
