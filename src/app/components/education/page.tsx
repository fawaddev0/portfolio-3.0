            ...
            {educations.map((education, index) => (
              ...
              >
                <Tilt
                  ...
                  scale={1.02}
                >
                  <div className="group relative p-8 rounded-3xl border border-white/10 bg-white/[0.02] backdrop-blur-md hover:border-purple-600/50 transition-all duration-500 shadow-xl overflow-hidden">
                    <div className="flex items-start gap-6 relative z-10">
                      <div className="w-14 h-14 rounded-2xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-500 shadow-[0_0_20px_rgba(168,85,247,0.2)]">
                      ...
                      <div className="flex flex-col gap-3">
                        <div className="flex flex-col gap-1">
                          ...
                          <h3 className="text-xl md:text-2xl font-bold text-white group-hover:text-purple-500 transition-colors">
                            {education.title}
                          </h3>
                        </div>
          ...
          <div className="order-first lg:order-last">
            <SectionReveal direction="left">
              <div className="relative group p-10 lg:p-16 rounded-[40px] border border-white/5 bg-white/[0.01] backdrop-blur-3xl overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-purple-600/5 via-transparent to-purple-900/5" />
                <div className="relative z-10 flex flex-col gap-8 text-center lg:text-left">
                  ...
                  <div className="w-20 h-1 bg-gradient-to-r from-purple-600 to-transparent rounded-full mx-auto lg:mx-0" />
                </div>
              </div>
            </SectionReveal>
          </div>
