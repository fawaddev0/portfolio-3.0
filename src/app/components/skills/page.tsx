    ...
    <div className="mx-2 my-4 group">
      <div className="relative px-8 py-6 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-3xl transition-all duration-500 hover:border-purple-500/30 hover:bg-white/[0.05] flex items-center gap-4 shadow-xl">
        ...
        <div className="flex flex-col">
          <span className="text-sm font-bold text-white tracking-wide uppercase group-hover:text-purple-500 transition-colors">
            {skill}
          </span>
...
function Skills() {
  ...
  return (
    <div id="skills" className="relative z-50 py-24 lg:py-48 overflow-hidden ">
      ...
      <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-purple-950/10 blur-[120px] rounded-full pointer-events-none" />
